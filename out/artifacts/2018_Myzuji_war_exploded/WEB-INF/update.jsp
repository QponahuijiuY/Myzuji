...
<script type="text/javascript">
	...
	function fun(){
		...
		var fileload = document.getElementById("url").value;
 ...
 -->
	<section id="knowledge" class="viewBlock">
		...
		<div class="reg_div">
			...
			<input id="url" type="hidden" name="url" value="${zuji.url }">
			<input type="hidden" name="id" value="${zuji.id }">
			
			
			<ul class="reg_ul" style="list-style: none">
				<li><span class="span">标题</span> <input type="text" name="title" value="${zuji.title }"
					placeholder="请输入成长概要" class="reg_user" id="username">
				</li>
				<li><span class="span">简介</span> <textarea placeholder="请输入成长简介"
						class="reg_user" rows="10" cols="30" name="jianjie" id="jianjie">${zuji.jianjie }</textarea></li>
					...
					<div class="" style="width:395px">
						<div  class="calendarWarp" style="">
							<input type="text" name="date" class='ECalendar'
								id="ECalendar_case2" value="${zuji.date }" />
						</div>
					</div>
				</li>
				...
				<li><span class="span">图片</span> 
					...
					<img id="image"  src="${zuji.url }" width="100px" height="100px"/>
				</li>
				<li>
					<button style="align:center;" type="submit" name="button" class="red_button" onclick="return fun()">修改</button>
				</li>
			</ul>
			</form>
		</div>
